...
double PEPS<double>::local(const DArray<2> &O){
   ...
   DArray<3> dls;
   Environment::construct_double_layer('H',(*this)(0,0),O,dls);
   ...
   for(int c = 1;c < Lx-1;++c){
      ...
      Environment::construct_double_layer('H',(*this)(0,c),O,dls);
   ...
   Environment::construct_double_layer('H',(*this)(0,Lx-1),O,dls);
   ...
   for(int r = 1;r < Ly - 1;++r){
      ...
      Environment::construct_double_layer('H',(*this)(r,Lx-1),dlo);
      ...
      for(int c = Lx-2;c > 0;--c){
         ...
         Environment::construct_double_layer('H',(*this)(r,c),dlo);
      ...
      //first site make double layer object from (*this)
      Environment::construct_double_layer('H',(*this)(r,0),O,dlo);
      ...
      //construct left renormalized operator
      Environment::construct_double_layer('H',(*this)(r,0),dlo);
      ...
      for(int c = 1;c < Lx-1;++c){
         ...
         Environment::construct_double_layer('H',(*this)(r,c),O,dlo);
      ...
      Environment::construct_double_layer('H',(*this)(r,Lx-1),O,dlo);
   ...
   Environment::construct_double_layer('H',(*this)(Ly-1,0),O,dls);
   ...
   for(int c = 1;c < Lx-1;++c){
      ...
      Environment::construct_double_layer('H',(*this)(Ly-1,c),O,dls);
   ...
   Environment::construct_double_layer('H',(*this)(Ly-1,Lx-1),O,dls);
...
double PEPS<double>::energy(){
   ...
   //first S+
   Environment::construct_double_layer('H',(*this)(0,0),Sp,dlsp);
   ...
   //then S-
   Environment::construct_double_layer('H',(*this)(0,0),Sm,dlsm);
   ...
   //then Sz 
   Environment::construct_double_layer('H',(*this)(0,0),Sz,dlsz);
   ...
   for(int col = 1;col < Lx - 1;++col){
      ...
      Environment::construct_double_layer('H',(*this)(0,col),Sm,dlsm);
      ...
      Environment::construct_double_layer('H',(*this)(0,col),Sp,dlsp);
      ...
      Environment::construct_double_layer('H',(*this)(0,col),Sz,dlsz);
   ...
   Environment::construct_double_layer('H',(*this)(0,Lx-1),Sm,dlsm);
   ...
   Environment::construct_double_layer('H',(*this)(0,Lx-1),Sp,dlsp);
   ...
   Environment::construct_double_layer('H',(*this)(0,Lx-1),Sz,dlsz);
   ...
   for(int row = 1;row < Ly - 1;++row){
      ...
      //first site make double layer object from (*this)
      Environment::construct_double_layer('H',(*this)(row,Lx-1),dlou);
      ...
      for(int col = Lx-2;col > 1;--col){
         ...
         Environment::construct_double_layer('H',(*this)(row,col),dlou);
      ...
      Environment::construct_double_layer('H',(*this)(row,0),Sp,dlop);
      ...
      Environment::construct_double_layer('H',(*this)(row,0),Sm,dlom);
      ...
      Environment::construct_double_layer('H',(*this)(row,0),Sz,dloz);
      ...
      Environment::construct_double_layer('H',(*this)(row,0),dlou);
      ...
      for(int col = 1;col < Lx - 1;++col){
         ...
         Environment::construct_double_layer('H',(*this)(row,col),Sm,dlom);
         ...
         Environment::construct_double_layer('H',(*this)(row,col),Sp,dlop);
         ...
         Environment::construct_double_layer('H',(*this)(row,col),Sz,dloz);
      ...
      //1) first Lp with Sm
      Environment::construct_double_layer('H',(*this)(row,Lx-1),Sm,dlom);
      ...
      //2) then Lm with Sp
      Environment::construct_double_layer('H',(*this)(row,Lx-1),Sp,dlop);
      ...
      //3) then Lz with Sz
      Environment::construct_double_layer('H',(*this)(row,Lx-1),Sz,dloz);
   ...
   //first S+
   Environment::construct_double_layer('H',(*this)(Ly-1,0),Sp,dlsp);
   ...
   //then S-
   Environment::construct_double_layer('H',(*this)(Ly-1,0),Sm,dlsm);
   ...
   //then Sz 
   Environment::construct_double_layer('H',(*this)(Ly-1,0),Sz,dlsz);
   ...
   for(int col = 1;col < Lx-1;++col){
      ...
      // 1) construct Sm double layer
      Environment::construct_double_layer('H',(*this)(Ly-1,col),Sm,dlsm);
      ...
      Environment::construct_double_layer('H',(*this)(Ly-1,col),Sp,dlsp);
      ...
      Environment::construct_double_layer('H',(*this)(Ly-1,col),Sz,dlsz);
   ...
   //1) Sm to close down Lp
   Environment::construct_double_layer('H',(*this)(Ly-1,Lx-1),Sm,dlsm);
   ...
   //2) Sp to close down Lm
   Environment::construct_double_layer('H',(*this)(Ly-1,Lx-1),Sp,dlsp);
   ...
   //3) Sz to close down Lz
   Environment::construct_double_layer('H',(*this)(Ly-1,Lx-1),Sz,dlsz);
   ...
   //first S+
   Environment::construct_double_layer('V',(*this)(0,0),Sp,dlsp);
   ...
   //then S-
   Environment::construct_double_layer('V',(*this)(0,0),Sm,dlsm);
   ...
   //then Sz 
   Environment::construct_double_layer('V',(*this)(0,0),Sz,dlsz);
   ...
   for(int row = 1;row < Ly - 1;++row){
      ...
      // 1) construct Sm double layer
      Environment::construct_double_layer('V',(*this)(row,0),Sm,dlsm);
      ...
      // 2) then construct Sp double layer
      Environment::construct_double_layer('V',(*this)(row,0),Sp,dlsp);
      ...
      // 3) then construct Sz double layer
      Environment::construct_double_layer('V',(*this)(row,0),Sz,dlsz);
   ...
   //1) Sm to close down Lp
   Environment::construct_double_layer('V',(*this)(Ly-1,0),Sm,dlsm);
   ...
   //2) Sp to close down Lm
   Environment::construct_double_layer('V',(*this)(Ly-1,0),Sp,dlsp);
   ...
   //3) Sz to close down Lz
   Environment::construct_double_layer('V',(*this)(Ly-1,0),Sz,dlsz);
   ...
   for(int col = 1;col < Lx - 1;++col){
      ...
      //first site make double layer object from (*this)
      Environment::construct_double_layer('V',(*this)(Ly-1,col),dlou);
      ...
      for(int row = Ly-2;row > 1;--row){
         ...
         Environment::construct_double_layer('V',(*this)(row,col),dlou);
      ...
      // 1) S+ -- make double layer object from (*this) with Sp
      Environment::construct_double_layer('V',(*this)(0,col),Sp,dlop);
      ...
      // 2) S- -- make double layer object from (*this) with Sm
      Environment::construct_double_layer('V',(*this)(0,col),Sm,dlom);
      ...
      // 3) Sz -- make double layer object from (*this) with Sz
      Environment::construct_double_layer('V',(*this)(0,col),Sz,dloz);
      ...
      // 4) 1 -- finally construct left renormalized operator with unity
      Environment::construct_double_layer('V',(*this)(0,col),dlou);
      ...
      for(int row = 1;row < Ly - 1;++row){
         ...
         //1) close down LOp with Sm
         Environment::construct_double_layer('V',(*this)(row,col),Sm,dlom);
         ...
         //2) close down LOm with Sp
         Environment::construct_double_layer('V',(*this)(row,col),Sp,dlop);
         ...
         //3) finally close down LOz with Sz
         Environment::construct_double_layer('V',(*this)(row,col),Sz,dloz);
      ...
      //1) first Lp with Sm
      Environment::construct_double_layer('V',(*this)(Ly-1,col),Sm,dlom);
      ...
      //2) then Lm with Sp
      Environment::construct_double_layer('V',(*this)(Ly-1,col),Sp,dlop);
      ...
      //3) then Lz with Sz
      Environment::construct_double_layer('V',(*this)(Ly-1,col),Sz,dloz);
   ...
   //first S+
   Environment::construct_double_layer('V',(*this)(0,Lx-1),Sp,dlsp);
   ...
   //then S-
   Environment::construct_double_layer('V',(*this)(0,Lx-1),Sm,dlsm);
   ...
   //then Sz 
   Environment::construct_double_layer('V',(*this)(0,Lx-1),Sz,dlsz);
   ...
   for(int row = 1;row < Ly-1;++row){
      ...
      // 1) construct Sm double layer
      Environment::construct_double_layer('V',(*this)(row,Lx-1),Sm,dlsm);
      ...
      // 2) construct Sp double layer
      Environment::construct_double_layer('V',(*this)(row,Lx-1),Sp,dlsp);
      ...
      // 3) construct Sz double layer
      Environment::construct_double_layer('V',(*this)(row,Lx-1),Sz,dlsz);
   ...
   //1) Sm to close down Lp
   Environment::construct_double_layer('V',(*this)(Ly-1,Lx-1),Sm,dlsm);
   ...
   //2) Sp to close down Lm
   Environment::construct_double_layer('V',(*this)(Ly-1,Lx-1),Sp,dlsp);
   ...
   //3) Sz to close down Lz
   Environment::construct_double_layer('V',(*this)(Ly-1,Lx-1),Sz,dlsz);
